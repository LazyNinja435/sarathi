"""One-off RAG SQLite validation; run: python verification/_sqlite_rag_check.py"""
import os
import sqlite3

ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
PATHS = [
    os.path.join(ROOT, "knowledge", "indexes", "sarathi_rag.sqlite"),
    os.path.join(ROOT, "app", "src", "main", "assets", "rag", "sarathi_rag.sqlite"),
]
