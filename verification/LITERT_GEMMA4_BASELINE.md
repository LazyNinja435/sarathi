...
## RAG status (from `app/src/main/assets/rag/sarathi_rag_manifest.json`)
...
3. Model File + Device Push — see `verification/smoke_litert_gemma4_adb.ps1` and `docs/LITERT_GEMMA4_SETUP.md`.  
...
7. Documentation + Report — `docs/LITERT_GEMMA4_SETUP.md`, `verification/LITERT_GEMMA4_TEST_REPORT.md`.
