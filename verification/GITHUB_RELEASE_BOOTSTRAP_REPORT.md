...
**Result:** **Blocked** in this environment — `scripts/build-release-apk.ps1` requires signing env vars (`SARATHI_KEYSTORE_PATH`, `SARATHI_KEYSTORE_PASSWORD`, `SARATHI_KEY_ALIAS`, `SARATHI_KEY_PASSWORD`).
...
`.\scripts\publish-github-release.ps1 -VersionName 0.1.0 -ReleaseType APP_ONLY -Tag v0.1.0`
...
`.\scripts\package-github-release.ps1 -VersionName 0.1.1 -VersionCode 2 -ReleaseType APP_ONLY`  
...
- `scripts/publish-github-release.ps1` — **`--latest`** behavior for app vs model creates.
- Updated: `AGENTS.md`, `docs/GITHUB_RELEASE_DISTRIBUTION.md`, `docs/IN_APP_UPDATES.md`, `docs/GITHUB_RELEASE_BOOTSTRAP_PLAN.md`, `verification/test-cases/SARATHI_GITHUB_RELEASE_UPDATE_TEST_CASES.md`, this report.
