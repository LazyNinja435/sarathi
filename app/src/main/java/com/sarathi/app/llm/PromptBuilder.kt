...
object PromptBuilder {
    ...
    private fun StringBuilder.appendRetrievedContext(retrievedContext: List<RagSearchResult>) {
        ...
        appendLine("- The final quote must directly support the user's concern and your main advice.")
        appendLine("- Do not use unrelated setup verses or scene-setting facts as the final quote.")
        appendLine("- If retrieved context is irrelevant, use a more relevant approved fallback Gita verse instead.")
