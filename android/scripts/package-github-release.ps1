...
.EXAMPLE
  ...
  .\android\scripts\publish-github-release.ps1 -ReleaseType MODEL_ONLY -Tag model-gemma-4-e2b
...
.EXAMPLE
  ...
  .\android\scripts\publish-github-release.ps1 -VersionName 0.1.0 -ReleaseType APP_ONLY
...
if ($ReleaseType -ne "MODEL_ONLY") {
    ...
    Write-Host ('  .\android\scripts\publish-github-release.ps1 -Repo "' + $Repo + '" -ReleaseType ' + $ReleaseType)
...
Write-Host ('  .\android\scripts\publish-github-release.ps1 -Repo "' + $Repo + '" -ReleaseType MODEL_ONLY -Tag ' + $ModelReleaseTag)
