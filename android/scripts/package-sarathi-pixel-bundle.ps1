...
$ApkSrc = Join-Path $RepoRoot "android\app\build\outputs\apk\debug\app-debug.apk"
$InstallScriptSrc = Join-Path $RepoRoot "android\scripts\install-sarathi-pixel.ps1"
