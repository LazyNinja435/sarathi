...
- Scripts: `scripts/create-release-keystore.ps1`, `scripts/print-release-cert-fingerprint.ps1`, `android/scripts/build-release-apk.ps1`.
- Documentation: `android/docs/ANDROID_RELEASE_SIGNING.md`.
...
- Orchestrator: `android/scripts/package-github-release.ps1` (calls build + split + manifest + checksums + verify).
...
- Script: `android/scripts/publish-github-release.ps1` (`gh` CLI, optional `-SkipModel`, `-Draft`, `-Prerelease`, `-ClobberUpload`).
