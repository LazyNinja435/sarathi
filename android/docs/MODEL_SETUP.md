...
For Gemma 4 E2B LiteRT-LM specifically, see **`android/docs/LITERT_GEMMA4_SETUP.md`**.
...
See **`android/docs/GEMMA_MODEL_DOWNLOAD.md`** for Hugging Face gating (401 without auth) and **manual** download steps — never store tokens in the repo.
...
1. Install Sarathi.
2. Copy a **`.litertlm`** (preferred) or **`.task`** file to one of the paths above (see also `android/docs/LITERT_GEMMA4_SETUP.md`).
