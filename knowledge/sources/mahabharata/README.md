...
The upstream repository may omit or truncate portions. The builder writes **coverage** and **TODO** style warnings into `processed/mahabharata_validation_report.json` and `knowledge/indexes/build_report.json` rather than claiming completeness.
